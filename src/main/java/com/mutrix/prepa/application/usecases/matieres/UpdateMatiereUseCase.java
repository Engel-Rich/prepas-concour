...
public class UpdateMatiereUseCase {
    ...
    public Matieres execute(UUID id, String name, String description, Boolean isActive, String logoUrl, Integer dureeNecessaireMinutes) {
        ...
        if (dureeNecessaireMinutes != null)                    matieres.setDureeNecessaireMinutes(dureeNecessaireMinutes);
