...
public final class CoursEntityMapper {
    ...
    public  static Cours toDCoursDomain(CoursEntity entity){
        ...
        return Cours.builder()
                ...
                .gratuit(entity.getGratuit() != null ? entity.getGratuit() : false)
                .hasBeenCrypted(entity.getHasBeenCrypted() != null ? entity.getHasBeenCrypted() : false)
                .encryptionError(entity.getEncryptionError())
    ...
    public static CoursEntity toCoursEntity(Cours cours, MatiereEntity matiereEntity, UserEntity userEntity){
        ...
        return CoursEntity.builder()
                ...
                .hasBeenCrypted(cours.getHasBeenCrypted() != null ? cours.getHasBeenCrypted() : false)
                .encryptionError(cours.getEncryptionError())
